...
class SendRequestRepeater(ActionListener):
    ...
    def actionPerformed(self, e):
        ...
        self._callbacks.sendToRepeater(host, port, secure, request.getRequest(), "AutorizePro")
...
class RetestSelectedRequest(ActionListener):
    ...
    def actionPerformed(self, e):
        start_new_thread(handle_message, (self._extender, "AUTORIZEPRO", False, self._extender._currentlyDisplayedItem._originalrequestResponse))
